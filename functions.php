...
add_action( 'wp_enqueue_scripts', 'my_assets' );
	function my_assets() {
		...
		wp_enqueue_style("style-fonts", "https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800;900&display=swap", array(), $style_version, 'all'); //Стили шрифта
		...
		wp_enqueue_style("style-tmp", get_template_directory_uri()."/css/style.css", array(), $style_version, 'all'); //Основные стили
